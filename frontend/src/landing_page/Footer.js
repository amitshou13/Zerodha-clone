...
function Footer() {
    return (
        <footer style={{backgroundColor:"rgb(250, 250, 250"}}>
            <div className='container border-top px-3'>
                <div className='row mt-5 px-5 text-muted' style={{lineHeight:1.7}}>
                ...
                <div className='px-5'>
                <div className='container mt-5 text-muted px-5' style={{ fontSize: "12px" }}>
