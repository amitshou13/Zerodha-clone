    ...
    return (
        <div className='container px-5'>
            <div className='row p-5 my-5'>
                <h1 className='fs-2 text-center' style={{lineHeight:'1.5'}}>We pioneered the discount broking model in India. <br/>Now, we are breaking ground with our technology.</h1>
            </div>
